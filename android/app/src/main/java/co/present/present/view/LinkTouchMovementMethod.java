...
/**
 * Taken from https://stackoverflow.com/a/20905824
 * Not translated into Kotlin in case I want to refer to the original :)
 */
public class LinkTouchMovementMethod extends LinkMovementMethod {
    ...
    public static LinkTouchMovementMethod getInstance() {
        if (instance == null) instance = new LinkTouchMovementMethod();
        return instance;
    }
}
