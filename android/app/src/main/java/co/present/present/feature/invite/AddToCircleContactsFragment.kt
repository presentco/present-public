...
class AddToCircleContactsFragment: AddToCircleFragment(), SearchFriendsEmptyView.InviteButtonClickListener {
    ...
    override fun getItemsAndInfo(circleId: String): Flowable<Triple<List<Group>, CurrentUser, String>> {
        return viewModel.getContactItemsAndInfo(circleId)
    }

    companion object {
        fun newInstance(circleId: String): AddToCircleContactsFragment {
            val fragment = AddToCircleContactsFragment()
